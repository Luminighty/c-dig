...
TileMeta tile_meta[TILE_SIZE] = {
	...
	[TILE_STONE] = TILE_META_BLOCK,
	[TILE_DIRT] = TILE_META_BLOCK,
	[TILE_MOSS] = TILE_META_BLOCK,

	[TILE_CRYSTAL] = TILE_META_BLOCK,
	[TILE_EMERALD] = TILE_META_BLOCK,
	[TILE_AMETHYST] = TILE_META_BLOCK,
	[TILE_RUBY] = TILE_META_BLOCK,

	[TILE_FUNGAL] = TILE_META_BLOCK,
	[TILE_FUNGAL_MOSS] = TILE_META_BLOCK,
	[TILE_FUNGAL_TRUNK] = TILE_META_BLOCK,
	[TILE_FUNGAL_CAP] = TILE_META_BLOCK,

	[TILE_ICE] = TILE_META_BLOCK,
	[TILE_SNOW] = TILE_META_BLOCK,

	[TILE_MAGMA] = TILE_META_BLOCK,
	[TILE_HELLSTONE] = TILE_META_BLOCK,

	[TILE_VOID] = TILE_META_BLOCK,
	[TILE_VOIDSTONE] = TILE_META_BLOCK,

	[TILE_STEAM] = TILE_META_BLOCK,
	[TILE_CHARCOAL] = TILE_META_BLOCK,

	[TILE_GRASS] = TILE_META_BLOCK,
	[TILE_COAL] = TILE_META_BLOCK,
	[TILE_IRON] = TILE_META_BLOCK,
	[TILE_DIAMOND] = TILE_META_BLOCK,
};
